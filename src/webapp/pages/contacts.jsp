    ...
    <c:if test="${!empty contacts}">
        <c:forEach items="${contacts}" var="contact">
            <tr>
                ...
                <td><a href="/contacts?action=delete&contactId=${contact.id}" class="btn btn-danger">Удалить</a></td>
                <td><a href="/contacts?action=edit&contactId=${contact.id}" class="btn btn-info">Изменить</a></td>
            </tr>
        </c:forEach>
    </c:if>
</table>
        ...
        <tr>
            <td>
                ...
                <input type="text" name="firstName"
                       <c:if test="${contactExist}">value="${contact.firstName}" </c:if>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <input type="text" name="lastName"
                       <c:if test="${contactExist}">value="${contact.lastName}" </c:if>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <input type="email" name="email"
                       <c:if test="${contactExist}">value="${contact.email}" </c:if>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <input type="text" name="gender"
                       <c:if test="${contactExist}">value="${contact.gender}" </c:if>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <input type="text" name="phone"
                       <c:if test="${contactExist}">value="${contact.phone}" </c:if>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <input type="date" name="date"
                       <c:if test="${contactExist}">value="${contact.date}" </c:if>
            </td>
        </tr>
        <tr>
            <td>
